...
{
	node_gradient[0] =   node_theta[1-1]*3.0;
	node_gradient[1] =   node_theta[2-1]*4.0;
	node_gradient[2] =   node_theta[3-1]*1.0E1;
	node_gradient[3] =   0.0;
	node_gradient[4] =   0.0;
	node_gradient[5] =   0.0;
	node_gradient[6] =   0.0;
...
{
	term_gradient[0] =   term_theta[1-1]*3.0;
	term_gradient[1] =   term_theta[2-1]*4.0;
}
