...
{
	node_gradient[0] =   node_theta[1-1]*1.019619566604595E-2;
	node_gradient[1] =   node_theta[2-1]*5.098097833022976E1;
	node_gradient[2] =   0.0;
	node_gradient[3] =   node_theta[4-1]*1.019619566604595E-4;
	node_gradient[4] =   0.0;
	node_gradient[5] =   0.0;
	node_gradient[6] =   0.0;
	node_gradient[7] =   0.0;
...
{
	term_gradient[0] =   term_theta[1-1]*(1.0/5.0E1);
	term_gradient[1] =   term_theta[2-1]*1.0E2;
	term_gradient[2] =   0.0;
}
