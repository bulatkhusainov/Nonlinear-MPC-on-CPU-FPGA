...
void f_jac_eval(float f_jac[n_node_eq][n_node_theta],float node_theta[n_node_theta])
{
	...
	f_jac[3][6] =   0.0;
	f_jac[3][7] =   0.0;
	f_jac[4][0] =   -pow(node_theta[2-1]+node_theta[6-1]*(1.0/4.0)+node_theta[8-1]*(1.0/4.0),2.0)+1.0;
	f_jac[4][1] =   -(node_theta[1-1]+node_theta[5-1]*(1.0/4.0)+node_theta[7-1]*(1.0/4.0))*(node_theta[2-1]*2.0+node_theta[6-1]*(1.0/2.0)+node_theta[8-1]*(1.0/2.0))-1.0;
	f_jac[4][2] =   1.0;
	f_jac[4][3] =   0.0;
	f_jac[4][4] =   pow(node_theta[2-1]+node_theta[6-1]*(1.0/4.0)+node_theta[8-1]*(1.0/4.0),2.0)*(-1.0/4.0)+1.0/4.0;
	f_jac[4][5] =   -(node_theta[1-1]+node_theta[5-1]*(1.0/4.0)+node_theta[7-1]*(1.0/4.0))*(node_theta[2-1]*(1.0/2.0)+node_theta[6-1]*(1.0/8.0)+node_theta[8-1]*(1.0/8.0))-1.0/4.0;
	f_jac[4][6] =   pow(node_theta[2-1]+node_theta[6-1]*(1.0/4.0)+node_theta[8-1]*(1.0/4.0),2.0)*(-1.0/4.0)-3.0/4.0;
	f_jac[4][7] =   -(node_theta[1-1]+node_theta[5-1]*(1.0/4.0)+node_theta[7-1]*(1.0/4.0))*(node_theta[2-1]*(1.0/2.0)+node_theta[6-1]*(1.0/8.0)+node_theta[8-1]*(1.0/8.0))-1.0/4.0;
	f_jac[5][0] =   1.0;
	f_jac[5][1] =   0.0;
	f_jac[5][2] =   0.0;
	f_jac[5][3] =   0.0;
