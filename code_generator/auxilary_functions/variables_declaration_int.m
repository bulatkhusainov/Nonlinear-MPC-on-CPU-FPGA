...
for i=1:nargin
    if strcmp(varargin(i),'2d')
        ...
        output_string = strcat(output_string, sprintf('%d,' , reshape(var_name.',[],1)),'};');
...
%        output_string = strcat(output_string, sprintf('}; \n'));  
    ...
    elseif strcmp(varargin(i),'1d')
        ...
        output_string = strcat(output_string, sprintf('%d,' , var_name),'};');
...
%         output_string = strcat(output_string,sprintf('}; \n'));
    ...
    elseif strcmp(varargin(i),'var')
        ...
        output_string = strcat(output_string,sprintf(strcat(data_type, 32, inputname(i+1),32, '= %d;\n'), varargin{i+1}));      
