...
fprintf(fileID,strcat('\t','// reset output\n'));
fprintf(fileID,strcat('\t','for(i = 0; i < n_states; i++) y_out->vec0[i] = 0;\n'));
...
fprintf(fileID,strcat('\t','for(i = 0; i < rem_partition*(n_node_theta+n_node_eq); i++) y_out->vec_rem[i] = 0;\n'));
fprintf(fileID,strcat('\t','#endif\n'));
fprintf(fileID,strcat('\t','for(i = 0; i < n_term_theta+n_term_eq; i++) y_out->vec_term[i] = 0;\n\n'));
...
fprintf(fileID,strcat('\t','int i_offset1, i_offset2;\n'));
fprintf(fileID,strcat('\t','// handle nonzero elements in node blocks\n'));
fprintf(fileID,strcat('\t','for(i = 0; i < part_size; i++)\n'));
fprintf(fileID,strcat('\t','{\n'));
