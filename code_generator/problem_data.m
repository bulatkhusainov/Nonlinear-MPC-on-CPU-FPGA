...
node_objective_residual = [sqrt(3)*x(1); sqrt(4)*x(2); sqrt(6)*u(1)]; % least squares format
term_objective_residual = [sqrt(8)*(term_x(1)); sqrt(4)*term_x(2)]; % least squares format
