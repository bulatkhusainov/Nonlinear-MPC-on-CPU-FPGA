...
%make_template('type','SOC','project_name','my_project0','input',block_interface,'input',x_in_interface,'output',y_out_interface,'soc_input',x_hat_soc_interface,'soc_output',all_theta_soc_interface);

ip_design_build('project_name','my_project0', 'input', block_interface, 'input', x_in_interface, 'output', y_out_interface);
