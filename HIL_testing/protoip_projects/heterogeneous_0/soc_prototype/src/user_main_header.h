...
#define n_all_theta 9  // # of optimization variables 
#define n_all_nu 8  // # of equality constraints 
#define n_all_lambda 2  // # of inequality constraints (assume no inequalities for terminal term) 
