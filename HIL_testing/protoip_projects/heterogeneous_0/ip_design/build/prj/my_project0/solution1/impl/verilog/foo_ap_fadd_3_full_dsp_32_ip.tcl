...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name foo_ap_fadd_3_full_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name foo_ap_fadd_3_full_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips foo_ap_fadd_3_full_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files foo_ap_fadd_3_full_dsp_32.xci]
generate_target {synthesis simulation} [get_files foo_ap_fadd_3_full_dsp_32.xci]
