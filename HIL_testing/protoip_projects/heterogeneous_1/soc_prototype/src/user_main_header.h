...
#define n_all_theta 63  // # of optimization variables 
#define n_all_nu 53  // # of equality constraints 
#define n_all_lambda 20  // # of inequality constraints (assume no inequalities for terminal term) 
