...
int write_stimuli(double input_data[], unsigned packet_internal_ID)
{
	...
	{
	case 0: //init_in
		// store init_in into ../../ip_design/test/stimuli/my_project0/init_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/my_project0/init_in.dat","w+");

		for (i = 0; i < INIT_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
	...
	case 1: //sc_in_in
		// store sc_in_in into ../../ip_design/test/stimuli/my_project0/sc_in_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/my_project0/sc_in_in.dat","w+");

		for (i = 0; i < SC_IN_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
	...
	case 3: //out_block_in
		...
		for (i = 0; i < OUT_BLOCK_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
	...
	case 4: //v_in_in
		// store v_in_in into ../../ip_design/test/stimuli/my_project0/v_in_in.dat
		pFile = fopen ("../../ip_design/test/stimuli/my_project0/v_in_in.dat","w+");

		for (i = 0; i < V_IN_IN_LENGTH; i++)
		{
			fprintf(pFile,"%2.18f \n",input_data[i]);
		}
		fprintf(pFile,"\n");
...
int read_results(double output_data[], unsigned packet_internal_ID, unsigned packet_output_size)
{
	...
	{
	case 0: //v_out_in
		// load ../../ip_design/test/results/my_project0/v_out_out.dat
		pFile = fopen ("../../ip_design/test/results/my_project0/v_out_out.dat","r");
	...
	case 1: //sc_out_in
		// load ../../ip_design/test/results/my_project0/sc_out_out.dat
		pFile = fopen ("../../ip_design/test/results/my_project0/sc_out_out.dat","r");
